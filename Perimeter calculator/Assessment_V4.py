        ...
        while not valid:
            ...
            try:
                ...
                if response > 150:
                    ...
                    print("Measurements can't be less than 0!")
                else:
                    print()
                    valid = True
            except ValueError:
            ...
            while not calcu:
                ...
                if choice == "area" or choice == "a":
                    ...
                    # rectangle area calculation
                        ...
                        print("The area of your rectangle is {}cm.".format(rectangle))
                    ...
                    # circle radius calculation
                        ...
                        print("The radius of your circle is {}cm.".format(circle))

                    else:
                        print()
                        print("Please input a shape (s, r and c are accepted)")
                        loop = True
                ...
                # perimeter calculation
                    ...
                    # rectangle perimeter calculation
                        ...
                        print("The perimeter of your rectangle is {}cm.".format(rectangle))
                ...
                # checks if the input is blank
                    ...
                    print()
                    print("Please input one of the choices (p and a are accepted).")
                    loop = True
