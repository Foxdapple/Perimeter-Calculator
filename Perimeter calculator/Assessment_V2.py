                ...
                while not pchoice:
                    ...
                    if choice == "area" or choice == "a":
                        ...
                        # rectangle area calculation
                            ...
                            print("The area of your rectangle is {}".format(rectangle))
                        ...
                        # circle radius calculation
                            ...
                            print("The radius of your circle is {}".format(circle))
                    ...
                    # perimeter calculation
                        ...
                        # rectangle perimeter calculation
                            ...
                            print("The perimeter of your rectangle is {}".format(rectangle))
                        ...
                        # circle circumference calculation
                            ...
                            print("The circumference of your circle is {}".format(circumference))
